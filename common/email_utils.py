...
if __name__=='__main__':
    html_path = os.path.dirname(__file__) + '/../test_reports/P1P2接口自动化测试报告V1.1/P1P2接口自动化测试报告V1.1.html'
    EmailUtils('<h3 align="center">微信公众号自动化测试报告</h3>',html_path).send_mail()